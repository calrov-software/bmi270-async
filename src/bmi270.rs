...
{
    /// Get the chip id.
    pub async fn get_chip_id(&mut self) -> Result<u8, Error<CommE, CsE>> {
        self.iface.read_reg(Registers::CHIP_ID).await
    }

    /// Get the errors from the error register.
    pub async fn get_errors(&mut self) -> Result<ErrorReg, Error<CommE, CsE>> {
    ...
    pub async fn get_status(&mut self) -> Result<Status, Error<CommE, CsE>> {
    ...
    pub async fn get_aux_data(&mut self) -> Result<AuxData, Error<CommE, CsE>> {
    ...
    pub async fn get_acc_data(&mut self) -> Result<AxisData, Error<CommE, CsE>> {
    ...
    pub async fn get_gyr_data(&mut self) -> Result<AxisData, Error<CommE, CsE>> {
        let mut payload = [0_u8; 7];
    ...
    /// Get the sensor time.
    pub async fn get_sensor_time(&mut self) -> Result<u32, Error<CommE, CsE>> {
    ...
    pub async fn get_data(&mut self) -> Result<Data, Error<CommE, CsE>> {
    ...
    pub async fn get_event(&mut self) -> Result<Event, Error<CommE, CsE>> {
    ...
    pub async fn get_int_status(&mut self) -> Result<InterruptStatus, Error<CommE, CsE>> {
    ...
    /// Get the step count.
    pub async fn get_step_count(&mut self) -> Result<u16, Error<CommE, CsE>> {
    ...
    pub async fn get_internal_status(&mut self) -> Result<InternalStatus, Error<CommE, CsE>> {
    ...
    pub async fn get_temperature(&mut self) -> Result<Option<f32>, Error<CommE, CsE>> {
    ...
    pub async fn get_fifo_len(&mut self) -> Result<i16, Error<CommE, CsE>> {
    ...
    pub async fn get_acc_range(&mut self) -> Result<AccRange, Error<CommE, CsE>> {
        let acc_range = self.iface.read_reg(Registers::ACC_RANGE).await?;
        Ok(AccRange::from_reg(acc_range))
    }

    /// Set the accelerometer range.
    pub async fn set_acc_range(&mut self, acc_range: AccRange) -> Result<(), Error<CommE, CsE>> {
        self.iface
            .write_reg(Registers::ACC_RANGE, acc_range as u8).await?;
        Ok(())
    }

    /// Get the gyroscope configuration.
    pub async fn get_gyr_conf(&mut self) -> Result<GyrConf, Error<CommE, CsE>> {
        let gyr_conf = self.iface.read_reg(Registers::GYR_CONF).await?;
        Ok(GyrConf::from_reg(gyr_conf))
    }

    /// Set the gyroscope configuration.
    pub async fn set_gyr_conf(&mut self, gyr_conf: GyrConf) -> Result<(), Error<CommE, CsE>> {
    ...
    pub async fn get_gyr_range(&mut self) -> Result<GyrRange, Error<CommE, CsE>> {
        let gyr_range = self.iface.read_reg(Registers::GYR_RANGE).await?;
        Ok(GyrRange::from_reg(gyr_range))
    }

    /// Set the gyroscope configuration.
    pub async fn set_gyr_range(&mut self, gyr_range: GyrRange) -> Result<(), Error<CommE, CsE>> {
    ...
    pub async fn get_aux_conf(&mut self) -> Result<AuxConf, Error<CommE, CsE>> {
    ...
    pub async fn set_aux_conf(&mut self, aux_conf: AuxConf) -> Result<(), Error<CommE, CsE>> {
    ...
    pub async fn get_fifo_downs(&mut self) -> Result<FifoDowns, Error<CommE, CsE>> {
    ...
    pub async fn set_fifo_downs(&mut self, fifo_downs: FifoDowns) -> Result<(), Error<CommE, CsE>> {
    ...
    pub async fn get_fifo_wtm(&mut self) -> Result<u16, Error<CommE, CsE>> {
    ...
    pub async fn set_fifo_wtm(&mut self, wtm: u16) -> Result<(), Error<CommE, CsE>> {
        let reg_0 = wtm as u8;
    ...
    pub async fn get_fifo_conf(&mut self) -> Result<FifoConf, Error<CommE, CsE>> {
    ...
    pub async fn set_fifo_conf(&mut self, fifo_conf: FifoConf) -> Result<(), Error<CommE, CsE>> {
    ...
    pub async fn get_saturation(&mut self) -> Result<Saturation, Error<CommE, CsE>> {
    ...
    pub async fn get_aux_dev_id(&mut self) -> Result<u8, Error<CommE, CsE>> {
        let dev_id = self.iface.read_reg(Registers::AUX_DEV_ID).await?;
        Ok(dev_id >> 1)
    }

    /// Set the auxiliary device id.
    pub async fn set_aux_dev_id(&mut self, dev_id: u8) -> Result<(), Error<CommE, CsE>> {
        let reg = dev_id << 1;
    ...
    pub async fn get_aux_if_conf(&mut self) -> Result<AuxIfConf, Error<CommE, CsE>> {
    ...
    pub async fn set_aux_if_conf(&mut self, aux_if_conf: AuxIfConf) -> Result<(), Error<CommE, CsE>> {
    ...
    pub async fn get_aux_rd_addr(&mut self) -> Result<u8, Error<CommE, CsE>> {
        let aux_rd_addr = self.iface.read_reg(Registers::AUX_RD_ADDR).await?;
        Ok(aux_rd_addr)
    }

    /// Set auxiliary device read address.
    pub async fn set_aux_rd_addr(&mut self, aux_rd_addr: u8) -> Result<(), Error<CommE, CsE>> {
        self.iface.write_reg(Registers::AUX_RD_ADDR, aux_rd_addr).await?;
        Ok(())
    }

    /// Get auxiliary device write address.
    pub async fn get_aux_wr_addr(&mut self) -> Result<u8, Error<CommE, CsE>> {
        let aux_wr_addr = self.iface.read_reg(Registers::AUX_WR_ADDR).await?;
        Ok(aux_wr_addr)
    }

    /// Set auxiliary device write address.
    pub async fn set_aux_wr_addr(&mut self, aux_wr_addr: u8) -> Result<(), Error<CommE, CsE>> {
        self.iface.write_reg(Registers::AUX_WR_ADDR, aux_wr_addr).await?;
        Ok(())
    }

    /// Get auxiliary device data to write.
    pub async fn get_aux_wr_data(&mut self) -> Result<u8, Error<CommE, CsE>> {
        let aux_wr_data = self.iface.read_reg(Registers::AUX_WR_DATA).await?;
        Ok(aux_wr_data)
    }

    /// Set auxiliary device data to write.
    pub async fn set_aux_wr_data(&mut self, aux_wr_data: u8) -> Result<(), Error<CommE, CsE>> {
        self.iface.write_reg(Registers::AUX_WR_DATA, aux_wr_data).await?;
        Ok(())
    }

    /// Get error register mask.
    pub async fn get_err_reg_msk(&mut self) -> Result<ErrorRegMsk, Error<CommE, CsE>> {
        let err_reg_msk = self.iface.read_reg(Registers::ERR_REG_MSK).await?;
        Ok(ErrorRegMsk::from_reg(err_reg_msk))
    }

    /// Get error register mask.
    pub async fn set_err_reg_msk(&mut self, err_reg_msk: ErrorRegMsk) -> Result<(), Error<CommE, CsE>> {
    ...
    pub async fn get_int1_io_ctrl(&mut self) -> Result<IntIoCtrl, Error<CommE, CsE>> {
    ...
    pub async fn set_int1_io_ctrl(&mut self, int1_io_ctrl: IntIoCtrl) -> Result<(), Error<CommE, CsE>> {
    ...
    pub async fn get_int2_io_ctrl(&mut self) -> Result<IntIoCtrl, Error<CommE, CsE>> {
    ...
    pub async fn set_int2_io_ctrl(&mut self, int2_io_ctrl: IntIoCtrl) -> Result<(), Error<CommE, CsE>> {
    ...
    pub async fn get_int_latch(&mut self) -> Result<IntLatch, Error<CommE, CsE>> {
        let int_latch = self.iface.read_reg(Registers::INT_LATCH).await?;
        Ok(IntLatch::from_reg(int_latch))
    }

    /// Set interrupt latched mode.
    pub async fn set_int_latch(&mut self, int_latch: IntLatch) -> Result<(), Error<CommE, CsE>> {
        self.iface
            .write_reg(Registers::INT_LATCH, int_latch as u8).await?;
        Ok(())
    }

    /// Get interrupt 1 feature mapping.
    pub async fn get_int1_map_feat(&mut self) -> Result<IntMapFeat, Error<CommE, CsE>> {
    ...
    pub async fn get_int2_map_feat(&mut self) -> Result<IntMapFeat, Error<CommE, CsE>> {
    ...
    pub async fn get_int_map_data(&mut self) -> Result<IntMapData, Error<CommE, CsE>> {
    ...
    pub async fn set_int_map_data(&mut self, int_map_data: IntMapData) -> Result<(), Error<CommE, CsE>> {
        let reg = int_map_data.to_reg();
        self.iface.write_reg(Registers::INT_LATCH, reg).await?;
        Ok(())
    }

    /// Get initialization control register.
    pub async fn get_init_ctrl(&mut self) -> Result<u8, Error<CommE, CsE>> {
        let init_ctrl = self.iface.read_reg(Registers::INIT_CTRL).await?;
        Ok(init_ctrl)
    }

    /// Set initialization control register (start initialization).
    pub async fn set_init_ctrl(&mut self, init_ctrl: u8) -> Result<(), Error<CommE, CsE>> {
        self.iface.write_reg(Registers::INIT_CTRL, init_ctrl).await?;
        Ok(())
    }

    /// Get init address.
    pub async fn get_init_addr(&mut self) -> Result<u16, Error<CommE, CsE>> {
    ...
    /// Set init address.
    pub async fn set_init_addr(&mut self, init_addr: u16) -> Result<(), Error<CommE, CsE>> {
    ...
    pub async fn get_init_data(&mut self) -> Result<u8, Error<CommE, CsE>> {
        let init_data = self.iface.read_reg(Registers::INIT_DATA).await?;
        Ok(init_data)
    }

    /// Set the initialization register.
    pub async fn set_init_data(&mut self, init_data: u8) -> Result<(), Error<CommE, CsE>> {
        self.iface.write_reg(Registers::INIT_DATA, init_data).await?;
        Ok(())
    }

    /// Get the internal errors.
    pub async fn get_internal_error(&mut self) -> Result<InternalError, Error<CommE, CsE>> {
        let internal_error = self.iface.read_reg(Registers::INTERNAL_ERROR).await?;
        Ok(InternalError::from_reg(internal_error))
    }

    /// Get ASDA pull up.
    pub async fn get_asda_pullup(&mut self) -> Result<PullUpConf, Error<CommE, CsE>> {
        let aux_if_trim = self.iface.read_reg(Registers::AUX_IF_TRIM).await?;
        Ok(PullUpConf::from_reg(aux_if_trim))
    }

    /// Set ASDA pull up.
    pub async fn set_asda_pullup(&mut self, pull_up_conf: PullUpConf) -> Result<(), Error<CommE, CsE>> {
        self.iface
            .write_reg(Registers::AUX_IF_TRIM, pull_up_conf.to_reg()).await?;
        Ok(())
    }

    /// Get gyroscope component retrimming register.
    pub async fn get_gyr_crt_conf(&mut self) -> Result<GyrCrtConf, Error<CommE, CsE>> {
    ...
    pub async fn set_gyr_crt_conf(&mut self, gyr_crt_conf: GyrCrtConf) -> Result<(), Error<CommE, CsE>> {
        self.iface
            .write_reg(Registers::GYR_CRT_CONF, gyr_crt_conf.to_reg()).await?;
        Ok(())
    }

    /// Get NVM configuration.
    pub async fn get_nvm_conf(&mut self) -> Result<bool, Error<CommE, CsE>> {
        let nvm_conf = self.iface.read_reg(Registers::NVM_CONF).await?;
        Ok((nvm_conf & 1 << 1) != 0)
    }

    /// Set NVM configuration.
    pub async fn set_nvm_conf(&mut self, gyr_crt_conf: bool) -> Result<(), Error<CommE, CsE>> {
        let value: u8 = if gyr_crt_conf { 0x01 } else { 0x00 };
        self.iface.write_reg(Registers::NVM_CONF, value << 1).await?;
        Ok(())
    }

    /// Get the interface configuration.
    pub async fn get_if_conf(&mut self) -> Result<IfConf, Error<CommE, CsE>> {
        let if_conf = self.iface.read_reg(Registers::IF_CONF).await?;
        Ok(IfConf::from_reg(if_conf))
    }

    /// Set the interface configuration.
    pub async fn set_if_conf(&mut self, if_conf: IfConf) -> Result<(), Error<CommE, CsE>> {
        self.iface.write_reg(Registers::IF_CONF, if_conf.to_reg()).await?;
        Ok(())
    }

    /// Get the drive strength configuration.
    pub async fn get_drv(&mut self) -> Result<Drv, Error<CommE, CsE>> {
        let drv = self.iface.read_reg(Registers::DRV).await?;
        Ok(Drv::from_reg(drv))
    }

    /// Set the drive strength configuration.
    pub async fn set_drv(&mut self, drv: Drv) -> Result<(), Error<CommE, CsE>> {
        self.iface.write_reg(Registers::DRV, drv.to_reg()).await?;
        Ok(())
    }

    /// Get the accelerometer self test configuration.
    pub async fn get_acc_self_test(&mut self) -> Result<AccSelfTest, Error<CommE, CsE>> {
    ...
    pub async fn set_acc_self_test(
        ...
        self.iface
            .write_reg(Registers::ACC_SELF_TEST, acc_self_test.to_reg()).await?;
        Ok(())
    }

    /// Get the gyroscope self test configuration.
    pub async fn get_gyr_self_test(&mut self) -> Result<GyrSelfTest, Error<CommE, CsE>> {
    ...
    pub async fn get_nv_conf(&mut self) -> Result<NvConf, Error<CommE, CsE>> {
        let nv_conf = self.iface.read_reg(Registers::NV_CONF).await?;
        Ok(NvConf::from_reg(nv_conf))
    }

    /// Set NV configuration.
    pub async fn set_nv_conf(&mut self, nv_conf: NvConf) -> Result<(), Error<CommE, CsE>> {
        self.iface.write_reg(Registers::NV_CONF, nv_conf.to_reg()).await?;
        Ok(())
    }

    /// Get accelerometer offsets.
    pub async fn get_acc_offsets(&mut self) -> Result<AccOffsets, Error<CommE, CsE>> {
    ...
    pub async fn set_acc_offsets(&mut self, acc_offsets: AccOffsets) -> Result<(), Error<CommE, CsE>> {
        let mut payload = [
            Registers::OFFSET_0,
            acc_offsets.x,
            acc_offsets.y,
    ...
    pub async fn get_gyr_offsets(&mut self) -> Result<GyrOffsets, Error<CommE, CsE>> {
    ...
    pub async fn set_gyr_offsets(&mut self, gyr_offsets: GyrOffsets) -> Result<(), Error<CommE, CsE>> {
        let mut payload = [0_u8; 5];
        payload[0] = Registers::OFFSET_3;
    ...
    pub async fn get_pwr_conf(&mut self) -> Result<PwrConf, Error<CommE, CsE>> {
        let pwr_conf = self.iface.read_reg(Registers::PWR_CONF).await?;
        Ok(PwrConf::from_reg(pwr_conf))
    }

    /// Set power configuration.
    pub async fn set_pwr_conf(&mut self, pwr_conf: PwrConf) -> Result<(), Error<CommE, CsE>> {
        self.iface
            .write_reg(Registers::PWR_CONF, pwr_conf.to_reg()).await?;
        Ok(())
    }

    /// Get power control.
    pub async fn get_pwr_ctrl(&mut self) -> Result<PwrCtrl, Error<CommE, CsE>> {
        let pwr_ctrl = self.iface.read_reg(Registers::PWR_CTRL).await?;
        Ok(PwrCtrl::from_reg(pwr_ctrl))
    }

    /// Set power control.
    pub async fn set_pwr_ctrl(&mut self, pwr_ctrl: PwrCtrl) -> Result<(), Error<CommE, CsE>> {
        self.iface
            .write_reg(Registers::PWR_CTRL, pwr_ctrl.to_reg()).await?;
        Ok(())
    }

    /// Send a command.
    pub async fn send_cmd(&mut self, cmd: Cmd) -> Result<(), Error<CommE, CsE>> {
        self.iface.write_reg(Registers::CMD, cmd as u8).await?;
        Ok(())
    }

    /// Initialize sensor.
    pub async fn init(&mut self, config_file: &[u8]) -> Result<(), Error<CommE, CsE>> {
